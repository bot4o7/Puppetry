...
namespace cheap {
	...
	void shader_program::set_uniform_vec1_texture_slot_array(const int* texture_slot_array) const
	{
		LOG();
	...
	void shader_program::set_uniform_mat4_projection_array(glm::mat4* projection_array) const
	{
		LOG();
	...
	int shader_program::get_uniform_projection_array_location(const char* name) const
	{
		LOG();
	...
	int shader_program::get_uniform_texture_slot_array_location(const char* name) const
	{
		LOG();
	...
	unsigned shader_program::create_program()
	{
		LOG();
	...
	unsigned shader_program::compile_shader(const unsigned shader_type, const std::string& shader_path)
	{
	...
	void shader_program::check_compile_errors(const unsigned shader_id, const unsigned shader_type)
	{
		LOG();
